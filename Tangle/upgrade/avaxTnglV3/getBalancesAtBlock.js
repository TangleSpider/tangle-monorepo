...
let getBalancesAtBlock = atBlock => {
    ...
    logs.forEach((log, i) => {
        ...
        let handleTransfer = () => {
            ...
            if (receiver == longAddress("0x7870B42206ed0bC0c53BdDeDCf684c96F70327c1") && amount / piecesPerUnit >= 1000000000) {
        ...
        */};
        let handleReflect = () => {
            ...
            */let liquidityAddress = "0x7870B42206ed0bC0c53BdDeDCf684c96F70327c1";

...
let getBalancesAtBlock = atBlock => {
    ...
    logs.forEach((log, i) => {
        ...
        let handleTransfer = () => {
            ...
            if (receiver == longAddress("0x1a610a2ae3eb219797a471ac62904e1269ab89b2") && amount / piecesPerUnit >= 1000000000) {
        ...
        */};
        let handleReflect = () => {
            ...
            */let liquidityAddress = "0x1a610a2ae3eb219797a471ac62904e1269ab89b2";

...
let getBalancesAtBlock = atBlock => {
    ...
    logs.forEach((log, i) => {
        ...
        let handleTransfer = () => {
            ...
            if (receiver == longAddress("0x16a7e5c3c928618d9ff554cf9945f2087bbe8db5") && amount / piecesPerUnit >= 1000000000) {
        ...
        */};
        let handleReflect = () => {
            ...
            */let liquidityAddress = "0x16a7e5c3c928618d9ff554cf9945f2087bbe8db5";

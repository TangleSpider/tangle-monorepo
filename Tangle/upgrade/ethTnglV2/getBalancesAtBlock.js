...
let getBalancesAtBlock = atBlock => {
    ...
    logs.forEach((log, i) => {
        ...
        let handleTransfer = () => {
            ...
            if (receiver == longAddress("0xae9c9efe298488c4457807542e575379536d11c3") && amount / piecesPerUnit >= 1000000000) {
        ...
        */let liquidityAddress = "0xae9c9efe298488c4457807542e575379536d11c3";

...
let getBalancesAtBlock = atBlock => {
    ...
    logs.forEach((log, i) => {
        ...
        let handleTransfer = () => {
            ...
            if (receiver == longAddress("0x22031f9706fab2fb0feff279e89cbaaea5d763de") && amount / piecesPerUnit >= 1000000000) {
            ...
            */let liquidityAddress = "0x22031f9706fab2fb0feff279e89cbaaea5d763de";

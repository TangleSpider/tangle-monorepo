    ...
    logs.forEach((log, i) => {
        ...
        if (topics[0] == transfer) {
            ...
            if (sender == longAddress("0x".padEnd(42, '0'))) {
                ...
                if (blockNumber >= 20213989)
                    console.log(parseInt(log.blockNumber).toString(), parseInt(totalLpSupply));
            }
            if (receiver == longAddress("0x".padEnd(42, '0'))) {
                totalLpSupply -= amount;
                if (blockNumber >= 20213989)
                    console.log(parseInt(log.blockNumber), parseInt(totalLpSupply));
            }

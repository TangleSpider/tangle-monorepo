...
contract Transferrer {
        ...
        internal
    {
        ...
        if (s.balances[receiver] == 0 && value > 0)
            addAirdroppingPoints(spender, 1);
    ...
    function addAirdroppingPoints(address address_, uint amount) internal {
         (bool success,) = address(this).call(
            abi.encodeWithSignature(
                "addAirdroppingPoints(address,uint256)",
                address_,
                amount
            )
        );
